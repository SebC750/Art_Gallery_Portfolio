            ...
            <footer >
                <div className="footer">
                    ...
                    <div className="social-media-links">
                        ...
                        <a href="https://www.deviantart.com/derpytots" className="logo-anchors"><img src="Assets/deviantart_logo.svg" className="social-media-logo" alt="this is the deviantart logo" /> <p> DerpyTots (No, I'm not a brony.)</p></a>
                    </div>
                </div>
            </footer>
        </div>
